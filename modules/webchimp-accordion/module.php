...
// Register Module
    add_action('dslc_hook_register_modules',
         create_function('', 'return dslc_register_module( "DSLC_webchimp_accordion" );')
    );
class DSLC_webchimp_accordion extends DSLC_Module {
	...
	function __construct() {
		...
		$this->module_id = 'DSLC_webchimp_accordion';
		$this->module_title = __( 'Webchimp accordion', 'live-composer-page-builder' );
		$this->module_icon = 'reorder';
		$this->module_category = 'Webchimp';
		$this->handle_like = 'Webchimp_accordion';
	}
				...
				<div class="dslc-accordion" data-open="<?php echo $options['open_by_default']; ?>">
					...
					<?php if ( is_array( $accordion_contents ) && count( $accordion_contents ) > 0 ) : ?>
						...
						<?php foreach ( $accordion_contents as $accordion_content ) : ?>
							...
							<div class="dslc-accordion-item" style="border: 10px solid red;">
								...
								<div class="dslc-accordion-content" style="background: yellow;">
					...
					<?php else : ?>
						...
						<div class="dslc-accordion-item"  style="background: yellow;">
